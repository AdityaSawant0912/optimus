 ...
 * so @optimus/core/@optimus/node — consumed elsewhere in this
 ...
 * (run `pnpm --filter @optimus/core build` / `...node build` first).
 */
module.exports = {
  resolve: {
    alias: {
      "@optimus/core": path.resolve(__dirname, "../core/dist/index.js"),
      "@optimus/node": path.resolve(__dirname, "../node/dist/index.js"),
    },
  },
};
